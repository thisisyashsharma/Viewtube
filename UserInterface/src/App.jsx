...
function App() {
  ...
  // Close drawer & profile on mobile route changes
  useEffect(() => {
    if (!isDesktop) {
  ...
  // Lock body scroll when mobile drawer or profile menu is open
  useEffect(() => {
    if (!isDesktop && (isDrawerOpen || isProfileOpen)) {
  ...
  }, [isDrawerOpen, isProfileOpen, isDesktop]);
