...
const faqs = [
  ...
  },
  {
    q: "How do I log in?",
    steps: [
      { title: "Quick summary", content: "Use Login page — enter email and password and submit." },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Open Publish, provide title/desc/thumbnail/video, then publish." },
      {
        title: "Step 1 — Open Publish/Upload",
        content: 'Select "Publish" or "Upload" from the sidebar or channel menu.'
      },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "MP4 (H.264 + AAC) is the recommended format." },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Upload thumbnail during publish; it will be stored locally or in cloud and shown on cards." },
      {
        title: "Step 1 — Upload",
        content: "Select a thumbnail when publishing a video (recommended 1280x720, 16:9)."
      },
      {
      ...
      },
      {
        ...
        content: "Keep file size under ~500KB and use 16:9 ratio for consistent layout."
      }
    ]
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "A view is recorded after the player passes a threshold (e.g., 5 seconds) and server validates it." },
      {
        title: "Step 1 — Client triggers",
        content: "When the video plays past a configured threshold, the client sends a 'view' event to the server."
      },
      {
      ...
      },
      {
        ...
        content: "Frontend updates the displayed view count either by polling or receiving real-time update."
      },
      {
        title: "Notes",
        content: "Tiny or quick visits are often ignored to prevent spammy counts."
      }
    ]
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Click Like/Dislike — frontend fires API to record reaction; UI updates optimistically." },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Post comments under videos; replies can be nested (commonly one-level deep)." },
      {
        title: "Step 1 — Post comment",
        content: "Type in the comment box and submit to create a top-level comment."
      },
      {
        title: "Step 2 — Reply",
        content: "Click Reply on a comment to show a nested input; submit to attach reply to that comment."
      },
      {
        title: "Step 3 — Data model",
        content: "Each comment: id, authorId, videoId, parentId (null for top-level), text, timestamps."
      },
      {
        title: "Step 4 — Moderation & UX",
        content: "Enable edit/delete for owner, rate-limiting, profanity filters, and lazy-loading/pagination for performance."
      }
    ]
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Find your comment, click Delete, confirm, and the server removes or soft-deletes it." },
      {
        title: "Step 1 — Locate",
      ...
      },
      {
        ...
        content: "Use the delete icon/button next to the comment and confirm the prompt."
      },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "History stores videos you watched; recorded on server with timestamp and retrievable from History page." },
      {
        title: "Step 1 — Client tracking",
        content: "After the view threshold is met the client sends a 'record history' event."
      },
      {
        title: "Step 2 — Server persistence",
        content: "Server stores userId, videoId, timestamp in a history collection/table."
      },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: 'Tap "Subscribe" on the channel header or the channel card; the button toggles and the server updates.' },
      {
        title: "Step 1 — Open channel",
        content: "Click the channel name/avatar from a video page or open the channel card."
      },
      {
      ...
      },
      {
        ...
        content: "Subscriber count increments and channel may appear in your subscriptions feed. Optionally enable upload notifications."
      },
      {
        title: "Troubleshooting",
        content:
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Use Customize Channel to update name, bio, avatar, banner and contact info." },
      {
        title: "Step 1 — Open Customize Channel",
        content: 'Navigate to "Customize Channel" from the sidebar or profile menu.'
      },
      {
        title: "Step 2 — Edit fields",
        content: "Change channel name, display name, bio/about, avatar image, and banner."
      },
      {
        title: "Step 3 — Save",
        content: "Click Save — frontend sends a PATCH with changed fields to the server."
      },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "While typing a handle the frontend checks availability (debounced) and shows inline feedback." },
      {
        title: "Step 1 — Live check",
        content: "Frontend sends a debounced request (300–500ms) as the user types."
      },
      {
        title: "Step 2 — Server validation",
      ...
      },
      {
        ...
        content: 'Show "Available" or "Already taken" and optionally suggested alternatives.'
      }
    ]
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Use Forgot Password — enter email, receive a secure link/OTP, then set a new password." },
      {
      ...
      {
        title: "Step 4 — Reset",
        content: "Open the link, enter new password twice, submit, then log in with the new password."
      }
    ]
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "After signup the server may send a verification link/OTP — complete it to verify your account." },
      {
        title: "Step 1 — Trigger",
        content: "Server sends verification automatically after signup or when you request it."
      },
      {
      ...
      },
      {
        ...
        content: "Click the link or enter the OTP to mark account as verified on the server."
      },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Client uses multipart/form-data; server parses with middleware (e.g., Multer) and stores/forwards the files." },
      {
        title: "Step 1 — Encoding",
        content: "Use multipart/form-data and file inputs (thumbnail + video fields)."
      },
      {
        title: "Step 2 — Upload UX",
        content: "Show an upload progress bar and optionally support drag-and-drop and resumable uploads."
      },
      {
      ...
      {
        title: "Best practice",
        content: "For very large files use chunked/resumable uploads and provide user-friendly progress & retry logic."
      }
    ]
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "From All Videos or channel page, click delete on your video and confirm — server removes the record and assets." },
      {
      ...
      },
      {
        ...
        content: "Click the delete icon/button and confirm the prompt in the UI."
      },
      {
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Server supports HTTP Range requests; the video element requests ranges for seeking and buffering." },
      {
      ...
      },
      {
        ...
        content: "<video> element handles range requests automatically and allows users to seek smoothly."
      },
      {
        title: "Step 3 — Performance tips",
        content: "Serve videos through a CDN for scale, or use cloud storage signed URLs for protection."
      }
    ]
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Define and enforce per-endpoint limits, use Redis or DB counters with TTL, and return clear cooldown messages." },
      {
      ...
      },
      {
        ...
        content: "Use Redis or in-memory counters with TTL to track attempts and deny when over the limit."
      },
      {
        title: "Step 3 — UX",
        content:
  ...
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Use Send Feedback in-app or the project's issue tracker; include reproduction steps and screenshots." },
      {
        title: "Step 1 — Send feedback",
        content: 'Click "Send Feedback" in the sidebar or use the contact/support link in the app.'
      },
      {
      ...
      },
      {
        ...
        content: "Optionally supply an email for follow-up; support may respond with a ticket ID or additional instructions."
      }
    ]
  },
  {
    ...
    steps: [
      { title: "Quick summary", content: "Use Account settings to export or delete data; confirm identity and follow on-screen steps." },
      {
      ...
      },
      {
        ...
        content: "Enter password or pass 2FA to confirm the destructive action."
      },
      {
...
function StepItem({ step, index }) {
  ...
  return (
    <div className="border rounded-xl overflow-hidden">
      ...
      >
        <div className="flex-1 text-left">
          <div className="text-sm sm:text-base font-medium text-gray-800">
            <span className="inline-block mr-2 text-blue-600">Step {index + 1}</span>
            {step.title}
          </div>
          {step.content ? (
      ...
      <div
        className={`px-4 pb-4 transition-[max-height,opacity] duration-300 ${open ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}
...
export default function Help() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-6 sm:py-8 lg:py-12 mt-6">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="mb-6 sm:mb-8 lg:mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-4xl font-semibold text-gray-900">Help & FAQ</h1>
        ...
        <main className="grid grid-cols-1 gap-6 lg:gap-10 lg:grid-cols-12">
          ...
          <section className="lg:col-span-8 space-y-4">
            {faqs.map((faq, i) => {
              ...
              return (
                <article
                  key={i}
                  className="bg-white border-4 border-gray-100 rounded-2xl shadow-sm overflow-hidden"
                >
                  <button
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center justify-between gap-4">
                        <h2 className="text-base sm:text-lg font-medium text-gray-800">{faq.q}</h2>
                  ...
                  <div
                    className={`px-4 sm:px-6 pb-6 transition-[max-height,opacity] duration-300 ${open ? "max-h-[2000px] opacity-100" : "max-h-0 opacity-0"}`}
                    aria-hidden={!open}
                  >
                    ...
                    <div className="mt-4 sm:mt-6 text-sm text-gray-600">
                      <p>
                        Want more details?{" "}
                        <Link to="/help/details" className="text-blue-600 hover:underline">
                          Open more details
                        </Link>{" "}
                        — placeholder.
                      </p>
          ...
          <aside className="hidden lg:block lg:col-span-4">
            <div className="sticky top-20 space-y-4">
              ...
              <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
                <h3 className="text-sm font-semibold text-gray-800">Tips for mobile</h3>
                <ul className="mt-3 text-sm text-gray-600 space-y-2">
                  <li>Tap a question to expand steps.</li>
                  <li>Tap a step to read full details and substeps.</li>
                  <li>Use landscape mode for wider video thumbnails and examples.</li>
                </ul>
              </div>
            </div>
          </aside>
        ...
        <footer className="mt-8 sm:mt-10 mb-6 text-sm text-gray-500 max-w-3xl">
        </footer>
      </div>
    </div>
  );
