...
import { LineDrawIcon, ProfileAnimAvatar } from "./common";
    ...
    <PageContainer>
      ...
      <div className="sm:hidden flex items-center justify-between py-2 px-1 mb-4 border-b border-gray-100 dark:border-gray-800">
        ...
        <div className="flex items-center space-x-3 text-gray-700 dark:text-gray-300">
          <button className="p-1 hover:text-gray-900 dark:hover:text-gray-100 text-gray-600 dark:text-gray-300 transition-colors group" title="Notifications">
            <LineDrawIcon
          ...
          <button onClick={() => navigate("/home")} className="p-1 hover:text-gray-900 dark:hover:text-gray-100 text-gray-600 dark:text-gray-300 transition-colors group" title="Search">
            <LineDrawIcon
          ...
          <Link to="/settings" className="p-1 hover:text-gray-900 dark:hover:text-gray-100 text-gray-600 dark:text-gray-300 transition-colors group" title="Settings">
            <LineDrawIcon
