...
import { LineDrawIcon, PrismText } from "./common";
  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed top-0 left-0 z-[var(--z-drawer,50)] lg:z-20 flex flex-col flex-shrink-0 h-full w-[280px] max-w-[85vw] lg:w-auto pt-16 font-semibold text-[1rem] text-gray-900 dark:text-gray-100 bg-white/95 dark:bg-[#0f0f0f]/95 backdrop-blur-2xl border-r-[0.35rem] border-gray-200/80 dark:border-gray-800/80 shadow-2xl ${
          isDragging ? "" : "transition-[transform,width] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]"
                  ...
                  item.active ? (
                    <li key={index}>
                      ...
                      >
                        ...
                        />
                        <PrismText text={item.name} className="ml-4" />
                      </Link>
                    </li>
                  ) : null
                )}
                    ...
                    <li>
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Subscriptions" className="ml-4" />
                      </Link>
                    </li>
                    <li>
                      <Link
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Your Channel" className="ml-4" />
                      </Link>
                    </li>
                    <li>
                      <Link
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="History" className="ml-4" />
                      </Link>
                    </li>
                    <li>
                      <Link
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Likes" className="ml-4" />
                      </Link>
                    </li>
                    <li className="my-2 border-b-[3px] border-gray-200/60 dark:border-gray-800/60 rounded-full list-none"></li>
                    <li>
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Trending" className="ml-4" />
                      </Link>
                    </li>
                    <li>
                      <Link
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Long Form" className="ml-4" />
                      </Link>
                    </li>
                    <li className="my-2 border-b-[3px] border-gray-200/60 dark:border-gray-800/60 rounded-full list-none"></li>
                    <li>
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Settings" className="ml-4" />
                      </Link>
                    </li>
                    <li>
                      <Link
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Custom Account" className="ml-4" />
                      </Link>
                    </li>
                    <li className="my-2 border-b-[3px] border-gray-200/60 dark:border-gray-800/60 rounded-full list-none"></li>
                    <li>
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Report History" className="ml-4" />
                      </Link>
                    </li>
                    <li>
                      <Link
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Help" className="ml-4" />
                      </Link>
                    </li>
                    <li>
                      <Link
                      ...
                      >
                        <LineDrawIcon
                          ...
                          activeColor="text-gray-900 dark:text-gray-100"
                        />
                        <PrismText text="Send Feedback" className="ml-4" />
                      </Link>
                    </li>
                  </>
                )}
